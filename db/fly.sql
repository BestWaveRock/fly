...
CREATE DATABASE  `fly` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sys_menu` VALUES (4001, '文档扩展', 'doc', NULL, 'http://biscuits-gateway:9999/swagger-ui.html', 4000, 'iconfont icon-biaodan', '1', 2, '0', '1', '0', '', '2018-06-26 10:50:32', 'admin', '2023-02-23 20:01:29', '0');
...
INSERT INTO `sys_oauth_client_details` VALUES (5, 'biscuits', NULL, 'biscuits', 'server', 'password,refresh_token,authorization_code,client_credentials,mobile', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login,http://localhost:8080/renren-admin/sys/oauth2-sso,http://localhost:8090/sys/oauth2-sso', NULL, 43200, 2592001, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\",\"online_quantity\":\"1\"}', 'false', '0', '', 'admin', NULL, '2023-03-08 11:32:41');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'ROLE_ADMIN', '超级管理员', '', 'admin', '2017-10-29 15:45:51', '2023-07-07 14:55:07', '0');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$mbRwrzRW/BmqyRK7BCmdheNINWIJvor5vANCdhQi4DgMAt71z9NdO', '', '19912345678', '/admin/sys-file/s3demo/7ff4ca6b7bf446f3a5a13ac016dc21af.png', '超级管理员', '超级管理员', 'biscuits@gmail.com', 4, ' ', 'admin', '2018-04-20 07:15:18', '2023-07-07 14:55:40', '0', '0', NULL, 'oBxPy5E-v82xWGsfzZVzkD3wEX64', NULL, 'log4j', NULL);
COMMIT;
